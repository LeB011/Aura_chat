...
class Prospect(TimestampedModel):
    ...
    business_domain: Optional[str] = None  # normalized category: administratif, informatique, etc.
    founded_year: Optional[int] = None
    founded_year_source: Optional[str] = None
    founded_year_confidence: Optional[int] = None
    # V6 Data Intelligence: transparent multi-source verification
...
class SecuritySettings(BaseModel):
    ...
    minimum_verification_to_send: int = 50
    block_unverified_contact: bool = True
    block_personal_email: bool = True
    audit_every_send: bool = True
