...
class TinyFishProvider(ProspectSearchProvider):
    ...
    def _business_domain(self, text: str, criteria: SearchCriteria) -> str:
        corpus=self._normalize((criteria.industry or "") + " " + (text or "")[:25000])
        scores=[]
        ...
        if scores:
            ...
            return scores[0][1]
        # Stable fallback: requested industry, rather than a misleading generic title.
        return self._normalize(criteria.industry or "autre")[:60]
