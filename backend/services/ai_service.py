...
def _client() -> AsyncOpenAI:
    """Standard OpenAI client. No Emergent-specific dependency."""
...
async def _ask_openai(system: str, prompt: str, model: str) -> str:
    """Call OpenAI through the public SDK and return plain text."""
    client = _client()
...
{{
  ...
  "confidence_score": 0-100
    ...
    try:
        resp = await _ask_openai(system, prompt, model)
