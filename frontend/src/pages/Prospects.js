...
export default function Prospects() {
  ...
  useEffect(() => { load(); /* eslint-disable-next-line */ }, [status, minScore, campaignId]);
  ...
  const exportCsv = () => {
    const headers = ["company_name","industry","city","website","email","phone","status","score","source"];
                  ...
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex items-start gap-2 min-w-0 flex-1">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="text-xs text-muted-foreground truncate">{p.industry} · {p.city}</div>
